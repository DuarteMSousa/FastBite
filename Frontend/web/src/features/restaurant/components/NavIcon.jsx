const ICON_PATHS = {
  ...
  kitchen: (
    <>
      <path d="M6 13.87A4 4 0 0 1 7.41 6a5.11 5.11 0 0 1 1.05-1.54 5 5 0 0 1 7.08 0A5.11 5.11 0 0 1 16.59 6 4 4 0 0 1 18 13.87V18a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1Z" />
...
export function NavIcon({ id, size = 20 }) {
  const content = ICON_PATHS[id]
  if (!content) {
    return (
      <svg
