...
export function mapTracking(payload) {
  ...
  return {
    ...
    pickup_latitude: nullableNumber(order?.restaurant?.address?.latitude),
    pickup_longitude: nullableNumber(order?.restaurant?.address?.longitude),
    dropoff_latitude: nullableNumber(order?.address?.latitude),
    dropoff_longitude: nullableNumber(order?.address?.longitude),
